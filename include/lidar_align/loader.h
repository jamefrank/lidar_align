...
namespace lidar_align
{
  ...
  public:
    ...
    std::vector<std::string> _findFilesByPattern(const std::string &directoryPath, const std::string &filePatternStr);
    bool loadPointcloudFromPcdDir(const std::string &pcd_dir, const Scan::Config &scan_config, Lidar *lidar);
    ...
    bool loadTfromFromTxt(const std::string &txt_path, Odom *odom);
